"""
Template 176 — NUMBER LINE: [0,100] STAR_YELLOW
"""
class SceneTemplate(AmharicEduScene):
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            ...
            nl.move_to(DOWN*0.5)
            t = ValueTracker(0)
            marker = always_redraw(lambda: Triangle(fill_color=STAR_YELLOW, fill_opacity=1,
            ...
            val_lbl = always_redraw(lambda: latin_text(f"{t.get_value():.1f}",
                font_size=FONT_SIZE_CAPTION, color=STAR_YELLOW).next_to(nl.n2p(t.get_value()), UP, buff=0.35))

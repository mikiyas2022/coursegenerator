"""
Template 0130 — CURVE: tanh FORCE_COLOR
"""
class SceneTemplate(AmharicEduScene):
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            ...
            import math
            curve = axes.plot(lambda x: math.tanh(x), x_range=[-3.5,3.5], color=FORCE_COLOR, stroke_width=3)
            lbl = latin_text("tanh", font_size=FONT_SIZE_CAPTION, color=FORCE_COLOR)

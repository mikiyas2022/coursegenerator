"""
Template 0369 — RINGS: 5rings ERROR_COLOR
"""
class SceneTemplate(AmharicEduScene):
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            rings = VGroup()
            for r in [0.4*i for i in range(1,5+1)]:
                ring = Circle(radius=r, color=ERROR_COLOR, stroke_width=1.5, stroke_opacity=0.3+r*0.1)
                rings.add(ring)

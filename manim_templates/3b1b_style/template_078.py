"""
Template 078 — CURVE PLOT: y = e^(0.3x) with VECTOR_COLOR
"""
class SceneTemplate(AmharicEduScene):
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            ...
            import math
            curve = axes.plot(lambda x: math.exp(x*0.3), x_range=[-3.5,3.5], color=VECTOR_COLOR, stroke_width=3)
            lbl = latin_text("y = e^(0.3x)", font_size=FONT_SIZE_CAPTION, color=VECTOR_COLOR)

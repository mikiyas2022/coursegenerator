"""
Template 0129 — CURVE: tanh VECTOR_COLOR
"""
class SceneTemplate(AmharicEduScene):
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            ...
            import math
            curve = axes.plot(lambda x: math.tanh(x), x_range=[-3.5,3.5], color=VECTOR_COLOR, stroke_width=3)
            lbl = latin_text("tanh", font_size=FONT_SIZE_CAPTION, color=VECTOR_COLOR)

"""
Template 0055 — CURVE: y=sin(x) SUCCESS_COLOR
"""
class SceneTemplate(AmharicEduScene):
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            ...
            import math
            curve = axes.plot(lambda x: math.sin(x), x_range=[-3.5,3.5], color=SUCCESS_COLOR, stroke_width=3)
            lbl = latin_text("y=sin(x)", font_size=FONT_SIZE_CAPTION, color=SUCCESS_COLOR)

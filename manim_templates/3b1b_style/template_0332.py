"""
Template 0332 — BARS: 5bars ROSE_COLOR
"""
class SceneTemplate(AmharicEduScene):
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            ...
            for i in range(5):
                h = 0.3+_r.random()*2.0
                bar = Rectangle(width=0.6, height=h, fill_color=ROSE_COLOR, fill_opacity=0.5+i*0.05, stroke_color=ROSE_COLOR, stroke_width=2)

"""
Template 0971 — TEXT: ERROR_COLOR FONT_SIZE_LABEL a1 e2
"""
class SceneTemplate(AmharicEduScene):
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            obj = latin_text("<NARRATION_PLACEHOLDER_0>", font_size=FONT_SIZE_LABEL, color=ERROR_COLOR)
            obj.move_to(ORIGIN)
            clamp_to_screen(obj)
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_1>") as tracker:
            ...
            ul = Line(obj.get_left(), obj.get_right(), color=ERROR_COLOR, stroke_width=3)

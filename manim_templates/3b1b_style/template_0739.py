"""
Template 0739 — TEXT: FORCE_COLOR FONT_SIZE_LABEL a6 e2
"""
class SceneTemplate(AmharicEduScene):
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            obj = latin_text("<NARRATION_PLACEHOLDER_0>", font_size=FONT_SIZE_LABEL, color=FORCE_COLOR)
            obj.move_to(ORIGIN)
            clamp_to_screen(obj)
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_1>") as tracker:
            ...
            ul = Line(obj.get_left(), obj.get_right(), color=FORCE_COLOR, stroke_width=3)

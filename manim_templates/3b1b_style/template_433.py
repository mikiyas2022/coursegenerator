"""
Template 433 — DEEP DIVE: y = 0.2x² ROSE_COLOR
"""
class SceneTemplate(AmharicEduScene):
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_1>") as tracker:
            ...
            import math
            curve = axes.plot(lambda x: x**2*0.2, x_range=[-3.5,3.5], color=ROSE_COLOR, stroke_width=3)
            lbl = latin_text("y = 0.2x²", font_size=FONT_SIZE_CAPTION, color=ROSE_COLOR)

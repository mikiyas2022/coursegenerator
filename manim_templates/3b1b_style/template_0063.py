"""
Template 0063 — CURVE: y=cos(x) ERROR_COLOR
"""
class SceneTemplate(AmharicEduScene):
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            ...
            import math
            curve = axes.plot(lambda x: math.cos(x), x_range=[-3.5,3.5], color=ERROR_COLOR, stroke_width=3)
            lbl = latin_text("y=cos(x)", font_size=FONT_SIZE_CAPTION, color=ERROR_COLOR)

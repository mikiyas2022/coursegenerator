"""
Template 104 — CURVE PLOT: sigmoid with TEAL_ACCENT
"""
class SceneTemplate(AmharicEduScene):
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            ...
            import math
            curve = axes.plot(lambda x: 2/(1+math.exp(-x))-1, x_range=[-3.5,3.5], color=TEAL_ACCENT, stroke_width=3)
            lbl = latin_text("sigmoid", font_size=FONT_SIZE_CAPTION, color=TEAL_ACCENT)

"""
Template 0104 — CURVE: y=0.5x+0.5 SUCCESS_COLOR
"""
class SceneTemplate(AmharicEduScene):
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            ...
            import math
            curve = axes.plot(lambda x: x*0.5+0.5, x_range=[-3.5,3.5], color=SUCCESS_COLOR, stroke_width=3)
            lbl = latin_text("y=0.5x+0.5", font_size=FONT_SIZE_CAPTION, color=SUCCESS_COLOR)

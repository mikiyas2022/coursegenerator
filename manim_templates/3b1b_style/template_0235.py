"""
Template 0235 — MORPH: RegularPolygon→Triangle ROSE_COLOR
"""
class SceneTemplate(AmharicEduScene):
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            s1 = RegularPolygon(color=ROSE_COLOR, fill_opacity=0.15, stroke_width=3)
            s1.move_to(LEFT*2)
            s2 = Triangle(color=SUCCESS_COLOR, fill_opacity=0.15, stroke_width=3)
            s2.move_to(RIGHT*2)

"""
Template 272 — BAR CHART: 5 bars FORCE_COLOR
"""
    ...
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            ...
            for i in range(5):
                ...
                bar = Rectangle(width=0.6, height=h, fill_color=FORCE_COLOR,
                    fill_opacity=0.5+i*0.05, stroke_color=FORCE_COLOR, stroke_width=2)

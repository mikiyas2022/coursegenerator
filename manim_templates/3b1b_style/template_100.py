"""
Template 100 — CURVE PLOT: y = |x| with FORCE_COLOR
"""
class SceneTemplate(AmharicEduScene):
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            ...
            import math
            curve = axes.plot(lambda x: abs(x), x_range=[-3.5,3.5], color=FORCE_COLOR, stroke_width=3)
            lbl = latin_text("y = |x|", font_size=FONT_SIZE_CAPTION, color=FORCE_COLOR)

"""
Template 270 — BAR CHART: 5 bars STAR_YELLOW
"""
    ...
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            ...
            for i in range(5):
                ...
                bar = Rectangle(width=0.6, height=h, fill_color=STAR_YELLOW,
                    fill_opacity=0.5+i*0.05, stroke_color=STAR_YELLOW, stroke_width=2)

"""
Template 0138 — CURVE: Lorentzian ROSE_COLOR
"""
class SceneTemplate(AmharicEduScene):
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            ...
            import math
            curve = axes.plot(lambda x: 1/(1+x**2), x_range=[-3.5,3.5], color=ROSE_COLOR, stroke_width=3)
            lbl = latin_text("Lorentzian", font_size=FONT_SIZE_CAPTION, color=ROSE_COLOR)

"""
Template 117 — CURVE PLOT: y = 0.8sin(2x) with VECTOR_COLOR
"""
class SceneTemplate(AmharicEduScene):
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            ...
            import math
            curve = axes.plot(lambda x: math.sin(x*2)*0.8, x_range=[-3.5,3.5], color=VECTOR_COLOR, stroke_width=3)
            lbl = latin_text("y = 0.8sin(2x)", font_size=FONT_SIZE_CAPTION, color=VECTOR_COLOR)

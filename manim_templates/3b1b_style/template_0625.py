"""
Template 0625 — TEXT: VECTOR_COLOR FONT_SIZE_BODY a6 e0
"""
class SceneTemplate(AmharicEduScene):
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            obj = latin_text("<NARRATION_PLACEHOLDER_0>", font_size=FONT_SIZE_BODY, color=VECTOR_COLOR)
            obj.move_to(ORIGIN)
            clamp_to_screen(obj)
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_1>") as tracker:
            ...
            dot = glow_dot(obj.get_corner(UR), color=VECTOR_COLOR)

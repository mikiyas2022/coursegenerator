"""
Template 0076 — CURVE: y=0.05x³ SUCCESS_COLOR
"""
class SceneTemplate(AmharicEduScene):
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            ...
            import math
            curve = axes.plot(lambda x: x**3*0.05, x_range=[-3.5,3.5], color=SUCCESS_COLOR, stroke_width=3)
            lbl = latin_text("y=0.05x³", font_size=FONT_SIZE_CAPTION, color=SUCCESS_COLOR)

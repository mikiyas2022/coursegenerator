"""
Template 0112 — CURVE: y=ln|x|+1 ERROR_COLOR
"""
class SceneTemplate(AmharicEduScene):
    def construct(self):
        ...
        with self.voiceover(text="<NARRATION_PLACEHOLDER_0>") as tracker:
            ...
            import math
            curve = axes.plot(lambda x: math.log(abs(x)+1), x_range=[-3.5,3.5], color=ERROR_COLOR, stroke_width=3)
            lbl = latin_text("y=ln|x|+1", font_size=FONT_SIZE_CAPTION, color=ERROR_COLOR)

...
class Blackboard_10_Variation(BlackboardScene):
    def construct(self):
        ...
        step1 = Text("Variation 10", font="Inter", color=BB_CHALK_YELLOW, font_size=32).next_to(q_text, DOWN, buff=1.0).align_to(q_text, LEFT)
